...
export const Sidebar = () => {
  const isSideMenuOpen = useSideMenu((state) => state.isSideMenuOpen);
  ...
  return (
    <div>
      ...
      >
        <IoCloseOutline
          size={40}
          className="absolute top-5 right-5 cursor-pointer" onClick={ () => closeSideMenu()}
        />
        ...
        >
          ...
          <span className="ml-3 text-xl">Access</span>
        </Link>
        ...
        >
          ...
          <span className="ml-3 text-xl">GoOut</span>
        </Link>
